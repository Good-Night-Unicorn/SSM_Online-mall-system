            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">留言板展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="liuyanName" id="liuyanName" placeholder="留言标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../liuyan/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.liuyanPhoto" />
                                        <h5>{{item.liuyanName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.liuyanContent|subString}}</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
