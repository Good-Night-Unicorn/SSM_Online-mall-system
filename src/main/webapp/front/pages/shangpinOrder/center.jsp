    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinOrderUuidNumber" id="shangpinOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="buyNumber" id="buyNumber"  lay-verify="required|integer"   placeholder="购买数量" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinOrderTruePrice" id="shangpinOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shangpinOrderTypes" id="shangpinOrderTypes">
                                    <option v-for="item in shangpinOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shangpinOrderPaymentTypes" id="shangpinOrderPaymentTypes">
                                    <option v-for="item in shangpinOrderPaymentTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`shangpinOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
