                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in dataList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../shangpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('shangpin/list', 'get', param, function(res) {
