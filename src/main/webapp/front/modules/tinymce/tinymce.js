...
layui.define(['jquery'],function (exports) {
    ...
    t.render = function (option,callback) {
        ...
        option.toolbar = option.toolbar ? option.toolbar : 'undo redo | forecolor backcolor bold italic bullist numlist image';
        ...
        option.menubar = option.menubar ? option.menubar : 'file edit insert format';
