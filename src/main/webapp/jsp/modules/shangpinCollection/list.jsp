...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">商品收藏管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">商品收藏列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">商品收藏列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("shangpinCollection/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                shangpinCollectionDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var shangpinCollectionTypesCell = document.createElement('td');
            shangpinCollectionTypesCell.innerHTML = item.shangpinCollectionValue;
            row.appendChild(shangpinCollectionTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shangpinCollection/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshangpinCollection", "addshangpinCollection");
            window.location.href = "add-or-update.jsp"
        }
