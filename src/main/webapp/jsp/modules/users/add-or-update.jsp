							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6" style="display:none;">
										<label>角色</label>
										<input id="role" value="管理员" name="role" class="form-control" placeholder="角色">
									</div>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("users/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.password != null && res.data.password != ''){

					$("#password").val(res.data.password);
					}
					if(res.data != null && res.data != '' && res.data.role != null && res.data.role != ''){
