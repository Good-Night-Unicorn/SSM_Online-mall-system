            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">商品订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangpinOrderUuidNumber" name="shangpinOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.shangpinOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangpinOrderTruePrice" name="shangpinOrderTruePrice" class="form-control"
                                               v-model="ruleForm.shangpinOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="shangpinOrderValue" name="shangpinOrderValue" class="form-control"
                                           v-model="ruleForm.shangpinOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="shangpinOrderPaymentValue" name="shangpinOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.shangpinOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shangpinOrder/info/" + id,
