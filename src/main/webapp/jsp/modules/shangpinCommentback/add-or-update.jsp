    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑商品评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">商品评价管理</li>
                        <li class="breadcrumb-item active">编辑商品评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">商品评价信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 shangpinCommentbackTextDiv">
                                        <label>评价内容</label>
                                        <textarea style="width: 450px"  id="shangpinCommentbackText" name="shangpinCommentbackText" class="form-control"placeholder="评价内容"></textarea>
                                    </div>
...
<script>
    ...
    var tableName = "shangpinCommentback";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("shangpinCommentback/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addshangpinCommentback');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                shangpinId: "required",
                yonghuId: "required",
                shangpinCommentbackText: "required",
                replyText: "required",
            },
            messages: {
                shangpinId: "商品不能为空",
                yonghuId: "用户不能为空",
                shangpinCommentbackText: "评价内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addshangpinCommentback = window.sessionStorage.getItem("addshangpinCommentback");
        if (addshangpinCommentback != null && addshangpinCommentback != "" && addshangpinCommentback != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("shangpinCommentback/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinCommentbackText").val(ruleForm.shangpinCommentbackText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#shangpinCommentbackText').attr('readonly', 'readonly');
