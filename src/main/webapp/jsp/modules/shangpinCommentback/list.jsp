...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">商品评价管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">商品评价列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">商品评价列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("shangpinCommentback/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                shangpinCommentbackDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评价内容
            var shangpinCommentbackTextCell = document.createElement('td');
            shangpinCommentbackTextCell.innerHTML = item.shangpinCommentbackText;
            row.appendChild(shangpinCommentbackTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shangpinCommentback/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshangpinCommentback", "addshangpinCommentback");
            window.location.href = "add-or-update.jsp"
        }
