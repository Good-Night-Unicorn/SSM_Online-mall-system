...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //商品原价
            var shangpinOldMoneyCell = document.createElement('td');
            shangpinOldMoneyCell.innerHTML = item.shangpinOldMoney;
            row.appendChild(shangpinOldMoneyCell);
    ...
    //查询当前表搜索条件所有列表
        ...
        function plusShangpinKucunNumber(thisId,shangpinKucunNumber) {
            ...
            $("#plusOrReduceShangpinKucunNumberTitle").val("增加库存");
        ...
        function reduceShangpinKucunNumber(thisId,shangpinKucunNumber) {
            ...
            $("#plusOrReduceShangpinKucunNumberTitle").val("减少库存");
            $("#thisShangpinKucunNumber").val(shangpinKucunNumber);
            $("#hideflag").val("-");
            $("#shangpinId").val(thisId);
            id=thisId;
