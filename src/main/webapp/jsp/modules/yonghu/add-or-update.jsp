                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 newMoneyDiv">
                                        <label>余额</label>
                                        <input style="width: 450px" id="newMoney" name="newMoney" class="form-control"
                                               onchange="newMoneyChickValue(this)" placeholder="余额">
                                    </div>
                                    <div class="form-group col-md-6 yonghuNewJifenDiv">
                                        <label>现积分</label>
                                        <input style="width: 450px" id="yonghuNewJifen" name="yonghuNewJifen" class="form-control"
                                               onchange="yonghuNewJifenChickValue(this)" placeholder="现积分">
                                    </div>
                                    <div class="form-group col-md-6 huiyuandengjiTypesDiv">
                                        <label>会员等级</label>
                                        <select style="width: 450px" id="huiyuandengjiTypesSelect" name="huiyuandengjiTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    function setSelectOption() {
        ...
        if(huiyuandengjiTypesSelect != null && huiyuandengjiTypesOptions != null  && huiyuandengjiTypesOptions.length > 0 ) {
            for (var i = 0; i < huiyuandengjiTypesOptions.length; i++) {
                if (huiyuandengjiTypesOptions[i].codeIndex == ruleForm.huiyuandengjiTypes) {//下拉框value对比,如果一致就赋值汉字
                        huiyuandengjiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 余额设置不可选
            $('#newMoney').attr('readonly', 'readonly');
            // 总积分设置不可选
            $('#yonghuSumJifen').attr('readonly', 'readonly');
            // 现积分设置不可选
            $('#yonghuNewJifen').attr('readonly', 'readonly');
            // 会员等级设置不可选
            $('#huiyuandengjiTypesSelect').attr('style', 'pointer-events: none;');
        }
        else{
            // alert("未知情况.......");
