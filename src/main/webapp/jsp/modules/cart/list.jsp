                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">购物车列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">购物车列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(shangpinKucunNumberCell);
                        ...
                        //购买获得积分
            var shangpinPriceCell = document.createElement('td');
            shangpinPriceCell.innerHTML = item.shangpinPrice;
            row.appendChild(shangpinPriceCell);
            ...
            row.appendChild(newMoneyCell);
                        ...
                        //会员等级
            var huiyuandengjiTypesCell = document.createElement('td');
            huiyuandengjiTypesCell.innerHTML = item.huiyuandengjiValue;
            row.appendChild(huiyuandengjiTypesCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addcart", "addcart");
            window.location.href = "add-or-update.jsp"
        }
