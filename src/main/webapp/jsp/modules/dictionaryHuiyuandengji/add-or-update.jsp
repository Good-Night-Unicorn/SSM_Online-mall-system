    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑会员等级类型</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">会员等级类型管理</li>
                        <li class="breadcrumb-item active">编辑会员等级类型</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">会员等级类型表信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>折扣</label>
                                    <input id="beizhu" name="beizhu" class="form-control" onchange="numberLimit(this)"
                                           placeholder="折扣">
                                </div>
...
<script>
    ...
    var tableName = "dictionaryHuiyuandengji";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "huiyuandengji_types";
            data["dicName"] = "会员等级类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"huiyuandengji_types"}, (res) => {
                if(res.code == 0){
